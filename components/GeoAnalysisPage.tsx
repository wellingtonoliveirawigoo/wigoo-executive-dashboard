...
const MONTH_TOTALS: Record<string, MonthEntry & { label: string }> = {
  ...
  '202604': { label: 'Abril',     rev: 271461, orders: 818,  sessions: 85769  },
};
...
const CAMPAIGNS: CampaignRow[] = [
  {
    ...
    src: 'meta / cpc',
    total: { rev: 214710, orders: 647, sessions: 63508 },
    months: {
      ...
      '202604': { rev: 46669,  orders: 131, sessions: 14803 },
    },
    byState: [
      { state:'SP', rev:77810, orders:252 }, { state:'MG', rev:14608, orders:45  },
      { state:'RJ', rev:13893, orders:46  }, { state:'RS', rev:11212, orders:43  },
      { state:'BA', rev:9541,  orders:27  }, { state:'PR', rev:9792,  orders:36  },
      ...
      { state:'PI', rev:2188,  orders:4   }, { state:'MT', rev:1316,  orders:5   },
    ...
    byStateMonth: {
      'SP': { '202601':{rev:21648.53,orders:62}, '202602':{rev:18574.88,orders:62}, '202603':{rev:20339.07,orders:76}, '202604':{rev:17324.86,orders:53} },
      'MG': { '202601':{rev:3112.8,orders:11},   '202602':{rev:7353.98,orders:24},  '202603':{rev:3391.9,orders:8},   '202604':{rev:749.71,orders:2}   },
      'RJ': { '202601':{rev:6408.73,orders:19},  '202602':{rev:5429.15,orders:20},  '202603':{rev:1497.23,orders:5},  '202604':{rev:558.34,orders:2}   },
      'RS': { '202601':{rev:1572.25,orders:5},   '202602':{rev:2047.13,orders:8},   '202603':{rev:4778.72,orders:19}, '202604':{rev:2813.55,orders:11}  },
      'BA': { '202601':{rev:1887.12,orders:5},   '202602':{rev:2124.02,orders:7},   '202603':{rev:2342.77,orders:7},  '202604':{rev:3187.12,orders:8}   },
      'SC': { '202601':{rev:1463.62,orders:5},   '202602':{rev:1228.04,orders:4},   '202603':{rev:3633.0,orders:12},  '202604':{rev:2895.85,orders:11}  },
      'PR': { '202601':{rev:1952.19,orders:8},   '202602':{rev:1497.58,orders:7},   '202603':{rev:4342.16,orders:13}, '202604':{rev:1999.65,orders:8}   },
      ...
      'PI': { '202601':{rev:0,orders:0},         '202602':{rev:0,orders:0},         '202603':{rev:398.82,orders:1},   '202604':{rev:1789.06,orders:3}   },
  ...
  },
  {
    ...
    src: 'meta / cpc',
    total: { rev: 108486, orders: 325, sessions: 17626 },
    months: {
      ...
      '202604': { rev: 20517,  orders: 66,  sessions: 2789 },
    },
    byState: [
      { state:'SP', rev:29743, orders:95  }, { state:'RJ', rev:13015, orders:40  },
      { state:'MG', rev:11337, orders:33  }, { state:'SC', rev:7729,  orders:23  },
      { state:'BA', rev:6896,  orders:16  }, { state:'RS', rev:5988,  orders:20  },
      { state:'PE', rev:5484,  orders:15  }, { state:'PR', rev:5442,  orders:17  },
      { state:'GO', rev:5271,  orders:12  }, { state:'DF', rev:3011,  orders:11  },
    ...
    byStateMonth: {
      'SP': { '202601':{rev:10223.15,orders:31}, '202602':{rev:7072.33,orders:22}, '202603':{rev:5847.4,orders:22},  '202604':{rev:6599.61,orders:20} },
      'RJ': { '202601':{rev:5451.26,orders:15},  '202602':{rev:2779.21,orders:9},  '202603':{rev:1700.6,orders:6},   '202604':{rev:3084.34,orders:10} },
      'MG': { '202601':{rev:4969.88,orders:12},  '202602':{rev:2962.72,orders:10}, '202603':{rev:2075.56,orders:6},  '202604':{rev:1328.40,orders:5}  },
  ...
  },
  {
    ...
    src: 'meta / cpc',
    total: { rev: 110174, orders: 377, sessions: 29525 },
    months: {
      ...
      '202604': { rev: 37350,  orders: 126, sessions: 11605 },
    },
    byState: [
      { state:'SP', rev:35384, orders:125 }, { state:'RJ', rev:22727, orders:75  },
      { state:'MG', rev:12544, orders:44  }, { state:'BA', rev:5065,  orders:14  },
      { state:'PE', rev:5035,  orders:16  }, { state:'RS', rev:4308,  orders:19  },
      { state:'ES', rev:4173,  orders:12  }, { state:'SC', rev:3193,  orders:9   },
      { state:'DF', rev:3415,  orders:12  }, { state:'CE', rev:2130,  orders:9   },
    ...
    byStateMonth: {
      'SP': { '202601':{rev:6990.67,orders:24},  '202602':{rev:9253.24,orders:31},  '202603':{rev:10504.31,orders:39}, '202604':{rev:8972.21,orders:32} },
      'RJ': { '202601':{rev:3134.16,orders:11},  '202602':{rev:3956.02,orders:13},  '202603':{rev:6512.51,orders:25},  '202604':{rev:9124.19,orders:26} },
      'MG': { '202601':{rev:2573.15,orders:8},   '202602':{rev:1883.9,orders:4},    '202603':{rev:3739.95,orders:16},  '202604':{rev:4530.18,orders:17} },
      ...
      'RS': { '202601':{rev:1276.02,orders:4},   '202602':{rev:698.87,orders:4},    '202603':{rev:761.07,orders:3},    '202604':{rev:2153.08,orders:9}  },
      'ES': { '202601':{rev:199.9,orders:1},     '202602':{rev:559.8,orders:2},     '202603':{rev:977.82,orders:3},    '202604':{rev:2436.13,orders:6}  },
      'DF': { '202601':{rev:417.55,orders:1},    '202602':{rev:794.93,orders:3},    '202603':{rev:773.38,orders:4},    '202604':{rev:1677.64,orders:5}  },
  ...
  },
  {
    ...
    src: 'meta / cpc',
    total: { rev: 98552, orders: 287, sessions: 27877 },
    months: {
      '202601': { rev: 24798,  orders: 71,  sessions: 7868  },
      '202602': { rev: 26752,  orders: 84,  sessions: 7775  },
      '202603': { rev: 24141,  orders: 77,  sessions: 7658  },
      '202604': { rev: 22861,  orders: 55,  sessions: 4576  },
    },
    byState: [
      { state:'SP', rev:37480, orders:112 }, { state:'MG', rev:10361, orders:33  },
      { state:'RJ', rev:7155,  orders:25  }, { state:'SC', rev:6114,  orders:17  },
      { state:'BA', rev:5156,  orders:11  }, { state:'DF', rev:4876,  orders:11  },
      { state:'RS', rev:4820,  orders:16  }, { state:'PR', rev:5071,  orders:13  },
      { state:'GO', rev:3434,  orders:10  }, { state:'PE', rev:3737,  orders:10  },
    ...
    byStateMonth: {
      'SP': { '202601':{rev:9892.74,orders:32},  '202602':{rev:10831.31,orders:32}, '202603':{rev:9614.32,orders:29},  '202604':{rev:7141.07,orders:19} },
      ...
      'RS': { '202601':{rev:708.71,orders:3},    '202602':{rev:1472.05,orders:6},   '202603':{rev:1516.75,orders:3},   '202604':{rev:1122.25,orders:4}  },
      'PR': { '202601':{rev:426.61,orders:1},    '202602':{rev:517.44,orders:2},    '202603':{rev:1530.87,orders:4},   '202604':{rev:3495.56,orders:6}  },
      'GO': { '202601':{rev:284.91,orders:1},    '202602':{rev:479.22,orders:2},    '202603':{rev:628.71,orders:2},    '202604':{rev:2040.84,orders:5}  },
      'PE': { '202601':{rev:1387.16,orders:3},   '202602':{rev:0,orders:0},         '202603':{rev:950.52,orders:3},    '202604':{rev:1698.69,orders:4}  },
  ...
  },
  {
    ...
    byState: [
      ...
      { state:'DF', rev:2547,  orders:6   }, { state:'MT', rev:2927,  orders:7   },
      { state:'SC', rev:1873,  orders:7   }, { state:'CE', rev:2051,  orders:6   },
    ...
    byStateMonth: {
      ...
      'MT': { '202601':{rev:1377.12,orders:4},  '202602':{rev:0,orders:0},        '202603':{rev:1134.5,orders:2},   '202604':{rev:414.80,orders:1} },
      'SC': { '202601':{rev:554.7,orders:2},    '202602':{rev:994.2,orders:3},    '202603':{rev:324.57,orders:2},   '202604':{rev:0,orders:0} },
      'CE': { '202601':{rev:575.82,orders:2},   '202602':{rev:590.81,orders:2},   '202603':{rev:599.8,orders:1},    '202604':{rev:284.91,orders:1} },
  ...
  },
  {
    ...
    src: 'meta / cpc',
    total: { rev: 72504, orders: 230, sessions: 10644 },
    months: {
      '202601': { rev: 25011,  orders: 79,  sessions: 3285 },
      '202602': { rev: 19337,  orders: 59,  sessions: 2646 },
      '202603': { rev: 15006,  orders: 51,  sessions: 2581 },
      '202604': { rev: 13150,  orders: 41,  sessions: 2132 },
    },
    byState: [
      { state:'SP', rev:22967, orders:76  }, { state:'RJ', rev:12862, orders:43  },
      { state:'MG', rev:7136,  orders:21  }, { state:'RS', rev:4556,  orders:13  },
    ...
    byStateMonth: {
      'SP': { '202601':{rev:7894.54,orders:27}, '202602':{rev:6141.61,orders:19}, '202603':{rev:3173.13,orders:13}, '202604':{rev:5757.22,orders:17} },
  ...
  },
  {
    ...
    byState: [
      ...
      { state:'PE', rev:3911,  orders:12  }, { state:'MT', rev:2556,  orders:4   },
      { state:'RS', rev:2733,  orders:10  }, { state:'DF', rev:2310,  orders:8   },
      ...
      { state:'PB', rev:304,   orders:1   }, { state:'AM', rev:547,   orders:2   },
    ...
    byStateMonth: {
      ...
      'PE': { '202601':{rev:0,orders:0}, '202602':{rev:0,orders:0}, '202603':{rev:2027.26,orders:6},   '202604':{rev:1884.16,orders:6}  },
      'MT': { '202601':{rev:0,orders:0}, '202602':{rev:0,orders:0}, '202603':{rev:2095.3,orders:3},    '202604':{rev:460.58,orders:1}   },
      'RS': { '202601':{rev:0,orders:0}, '202602':{rev:0,orders:0}, '202603':{rev:1562.06,orders:5},   '202604':{rev:1170.87,orders:5}  },
      'DF': { '202601':{rev:0,orders:0}, '202602':{rev:0,orders:0}, '202603':{rev:1002.26,orders:3},   '202604':{rev:1307.56,orders:5}  },
      ...
      'AM': { '202601':{rev:0,orders:0}, '202602':{rev:0,orders:0}, '202603':{rev:290.91,orders:1},    '202604':{rev:256.23,orders:1}   },
  ...
  },
  {
    ...
    src: 'meta / cpc',
    total: { rev: 56621, orders: 188, sessions: 17617 },
    months: {
      '202601': { rev: 0,      orders: 0,   sessions: 0     },
      '202602': { rev: 0,      orders: 0,   sessions: 0     },
      '202603': { rev: 34705,  orders: 114, sessions: 10329 },
      '202604': { rev: 21916,  orders: 74,  sessions: 7288  },
    },
    byState: [
  ...
  },
  {
    ...
    src: 'facebook / paid_social',
    total: { rev: 54775, orders: 179, sessions: 11283 },
    months: {
      '202601': { rev: 0,      orders: 0,   sessions: 0    },
      '202602': { rev: 0,      orders: 0,   sessions: 0    },
      '202603': { rev: 29407,  orders: 103, sessions: 5747 },
      '202604': { rev: 25367,  orders: 76,  sessions: 5536 },
    },
    byState: [
  ...
  },
  {
    ...
    src: 'meta / cpc',
    total: { rev: 55222, orders: 162, sessions: 15665 },
    months: {
      '202601': { rev: 0,      orders: 0,   sessions: 0     },
      '202602': { rev: 0,      orders: 0,   sessions: 0     },
      '202603': { rev: 37381,  orders: 110, sessions: 10805 },
      '202604': { rev: 17842,  orders: 52,  sessions: 4860  },
    },
    byState: [
      { state:'MG', rev:21928, orders:67  }, { state:'SP', rev:13710, orders:45  },
      { state:'BA', rev:5380,  orders:6   }, { state:'RJ', rev:5450,  orders:18  },
    ...
    byStateMonth: {
      'MG': { '202601':{rev:0,orders:0}, '202602':{rev:0,orders:0}, '202603':{rev:15600.04,orders:44}, '202604':{rev:6526.61,orders:24} },
      'SP': { '202601':{rev:0,orders:0}, '202602':{rev:0,orders:0}, '202603':{rev:9543.9,orders:31},   '202604':{rev:5160.23,orders:15} },
      'BA': { '202601':{rev:0,orders:0}, '202602':{rev:0,orders:0}, '202603':{rev:2611.15,orders:4},   '202604':{rev:2768.54,orders:2}  },
      'RJ': { '202601':{rev:0,orders:0}, '202602':{rev:0,orders:0}, '202603':{rev:4403.84,orders:13},  '202604':{rev:1045.16,orders:5}  },
  ...
  },
  {
    ...
    src: 'meta / cpc',
    total: { rev: 19784, orders: 70, sessions: 6763 },
    months: {
      '202601': { rev: 4455,  orders: 17, sessions: 1281 },
      '202602': { rev: 10072, orders: 33, sessions: 4319 },
      '202603': { rev: 583,   orders: 3,  sessions: 545  },
      '202604': { rev: 4674,  orders: 17, sessions: 618  },
    },
    byState: [
      { state:'SP', rev:7045, orders:25 }, { state:'RJ', rev:3027, orders:12 },
      { state:'MA', rev:1344, orders:2  }, { state:'MG', rev:1598, orders:6  },
      { state:'MT', rev:894,  orders:3  }, { state:'BA', rev:766,  orders:3  },
      { state:'RS', rev:1173, orders:5  }, { state:'PR', rev:433,  orders:2  },
      { state:'AL', rev:418,  orders:1  }, { state:'PE', rev:380,  orders:1  },
      { state:'SC', rev:639,  orders:3  }, { state:'PA', rev:810,  orders:2  },
      { state:'PB', rev:262,  orders:1  }, { state:'AM', rev:213,  orders:1  },
      { state:'GO', rev:213,  orders:1  }, { state:'ES', rev:190,  orders:1  },
    ],
    byStateMonth: {
      'SP': { '202601':{rev:1884.00,orders:9},  '202602':{rev:3697.83,orders:10}, '202603':{rev:82.85,orders:1},   '202604':{rev:1379.82,orders:5} },
      'RJ': { '202601':{rev:1338.40,orders:4},  '202602':{rev:597.13,orders:3},   '202603':{rev:120.77,orders:1},  '202604':{rev:971.17,orders:4}  },
      'MA': { '202601':{rev:0,orders:0},         '202602':{rev:1344.34,orders:2},  '202603':{rev:0,orders:0},       '202604':{rev:0,orders:0}        },
      'MG': { '202601':{rev:199.90,orders:1},   '202602':{rev:808.61,orders:3},   '202603':{rev:0,orders:0},       '202604':{rev:588.73,orders:2}  },
      ...
      'SC': { '202601':{rev:0,orders:0},         '202602':{rev:378.13,orders:2},   '202603':{rev:0,orders:0},       '202604':{rev:260.98,orders:1}  },
      'PA': { '202601':{rev:299.90,orders:1},   '202602':{rev:0,orders:0},        '202603':{rev:0,orders:0},       '202604':{rev:509.76,orders:1}  },
      ...
      'RS': { '202601':{rev:0,orders:0},         '202602':{rev:208.91,orders:1},   '202603':{rev:0,orders:0},       '202604':{rev:963.91,orders:4}  },
  ...
  },
  {
    ...
    src: 'meta / cpc',
    total: { rev: 5331, orders: 12, sessions: 522 },
    months: {
      '202601': { rev: 0,    orders: 0,  sessions: 0 },
      '202602': { rev: 0,    orders: 0,  sessions: 0 },
      '202603': { rev: 0,    orders: 0,  sessions: 0 },
      '202604': { rev: 5331, orders: 12, sessions: 522 },
    },
    byState: [
      { state:'SP', rev:1785, orders:5 }, { state:'CE', rev:2374, orders:2 },
      { state:'MG', rev:403,  orders:2 }, { state:'PE', rev:396,  orders:1 },
      { state:'MT', rev:374,  orders:2 },
    ],
    byStateMonth: {
      'SP': { '202601':{rev:0,orders:0}, '202602':{rev:0,orders:0}, '202603':{rev:0,orders:0}, '202604':{rev:1784.62,orders:5} },
      'CE': { '202601':{rev:0,orders:0}, '202602':{rev:0,orders:0}, '202603':{rev:0,orders:0}, '202604':{rev:2373.92,orders:2} },
...
const STATES: StateRow[] = [
  { name: 'São Paulo',           abbr: 'SP', rev: 335340, orders: 1093, ticket: 307, months: { '202601':{rev:77720,orders:243}, '202602':{rev:79193,orders:242}, '202603':{rev:99019,orders:357}, '202604':{rev:82270,orders:257} } },
  { name: 'Rio de Janeiro',      abbr: 'RJ', rev: 155371, orders: 489,  ticket: 318, months: { '202601':{rev:33133,orders:92},  '202602':{rev:34709,orders:106}, '202603':{rev:49199,orders:168}, '202604':{rev:38330,orders:123} } },
  { name: 'Minas Gerais',        abbr: 'MG', rev: 121171, orders: 366,  ticket: 331, months: { '202601':{rev:22390,orders:62},  '202602':{rev:22939,orders:76},  '202603':{rev:46629,orders:135}, '202604':{rev:29595,orders:95}  } },
  { name: 'Bahia',               abbr: 'BA', rev: 56732,  orders: 143,  ticket: 397, months: { '202601':{rev:15033,orders:35},  '202602':{rev:8106,orders:26},   '202603':{rev:16139,orders:42},  '202604':{rev:17734,orders:41}  } },
  { name: 'Rio Grande do Sul',   abbr: 'RS', rev: 53397,  orders: 181,  ticket: 295, months: { '202601':{rev:9838,orders:31},   '202602':{rev:10180,orders:38},  '202603':{rev:21189,orders:63},  '202604':{rev:12772,orders:50}  } },
  { name: 'Pernambuco',          abbr: 'PE', rev: 44611,  orders: 115,  ticket: 388, months: { '202601':{rev:9282,orders:27},   '202602':{rev:10568,orders:26},  '202603':{rev:11847,orders:32},  '202604':{rev:12914,orders:30}  } },
  { name: 'Paraná',              abbr: 'PR', rev: 41440,  orders: 132,  ticket: 314, months: { '202601':{rev:7236,orders:24},   '202602':{rev:7577,orders:25},   '202603':{rev:14905,orders:51},  '202604':{rev:11722,orders:32}  } },
  { name: 'Santa Catarina',      abbr: 'SC', rev: 38554,  orders: 122,  ticket: 316, months: { '202601':{rev:9594,orders:26},   '202602':{rev:7806,orders:26},   '202603':{rev:12371,orders:40},  '202604':{rev:9972,orders:35}   } },
  { name: 'Distrito Federal',    abbr: 'DF', rev: 32969,  orders: 92,   ticket: 358, months: { '202601':{rev:9416,orders:16},   '202602':{rev:7764,orders:24},   '202603':{rev:9909,orders:35},   '202604':{rev:6313,orders:19}   } },
  { name: 'Goiás',               abbr: 'GO', rev: 31424,  orders: 93,   ticket: 338, months: { '202601':{rev:7229,orders:20},   '202602':{rev:5609,orders:16},   '202603':{rev:10959,orders:36},  '202604':{rev:7812,orders:22}   } },
  { name: 'Espírito Santo',      abbr: 'ES', rev: 28649,  orders: 85,   ticket: 337, months: { '202601':{rev:8584,orders:23},   '202602':{rev:3473,orders:11},   '202603':{rev:9523,orders:31},   '202604':{rev:7070,orders:20}   } },
  { name: 'Ceará',               abbr: 'CE', rev: 28438,  orders: 70,   ticket: 406, months: { '202601':{rev:2355,orders:9},    '202602':{rev:3999,orders:11},   '202603':{rev:12754,orders:31},  '202604':{rev:9330,orders:19}   } },
  { name: 'Mato Grosso',         abbr: 'MT', rev: 18300,  orders: 49,   ticket: 373, months: { '202601':{rev:5870,orders:11},   '202602':{rev:3619,orders:13},   '202603':{rev:4488,orders:11},   '202604':{rev:4323,orders:14}   } },
  ...
  { name: 'Amazonas',            abbr: 'AM', rev: 11376,  orders: 25,   ticket: 455, months: { '202601':{rev:2544,orders:7},    '202602':{rev:2967,orders:4},    '202603':{rev:2893,orders:6},    '202604':{rev:2972,orders:8}    } },
  ...
  { name: 'Mato Grosso do Sul',  abbr: 'MS', rev: 7825,   orders: 23,   ticket: 340, months: { '202601':{rev:511,orders:2},     '202602':{rev:2704,orders:7},    '202603':{rev:3562,orders:10},   '202604':{rev:1428,orders:5}    } },
  ...
  { name: 'Alagoas',             abbr: 'AL', rev: 6319,   orders: 17,   ticket: 372, months: { '202601':{rev:3511,orders:7},    '202602':{rev:1012,orders:3},    '202603':{rev:820,orders:3},     '202604':{rev:976,orders:4}     } },
  ...
  { name: 'Piauí',               abbr: 'PI', rev: 4284,   orders: 11,   ticket: 390, months: { '202601':{rev:589,orders:1},     '202602':{rev:194,orders:1},     '202603':{rev:1712,orders:6},    '202604':{rev:1789,orders:3}    } },
  { name: 'Rondônia',            abbr: 'RO', rev: 3080,   orders: 9,    ticket: 342, months: { '202601':{rev:397,orders:2},     '202602':{rev:733,orders:3},     '202603':{rev:1751,orders:3},    '202604':{rev:200,orders:1}     } },
